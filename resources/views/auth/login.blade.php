...
<!-- https://allimages.sgp1.digitaloceanspaces.com/wikilaptopcom/2021/01/1610534235_Tong-hop-100-Background-dep-nhat.jpg -->
<body style="background-image:url(http://micaysasin.vn/upload/images/_AY26300.jpg);">
    <div class="container">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" value="Đăng nhập" class="btn float-right login_btn">
                        </div>
                    </form>
                </div>
